...
{$R 'w_PhoneSpell.TPhoneSpell.resources' 'w_PhoneSpell.resx'}
...
uses
  ...
  w_PhoneSpell in 'w_PhoneSpell.pas' {w_PhoneSpell.TPhoneSpell: System.Windows.Forms.Form};
...
[STAThread]
begin
  Application.Run(TPhoneSpell.Create);
end.
