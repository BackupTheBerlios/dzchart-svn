...
// File generated on 9/14/2000 3:46:32 PM from Type Library described below.
...
// Control Name     : TMSSScriptControl
...
// *********************************************************************//
  TMSSScriptControl = class(TOleControl)
  private
...
procedure TMSSScriptControl.InitControlData;
const
...
procedure TMSSScriptControl.CreateControl;
...
function TMSSScriptControl.GetControlInterface: IScriptControl;
begin
  CreateControl;
  Result := FIntf;
end;

function  TMSSScriptControl.Get_Modules: IScriptModuleCollection;
begin
  Result := DefaultInterface.Get_Modules;
end;

function  TMSSScriptControl.Get_Error: IScriptError;
begin
  Result := DefaultInterface.Get_Error;
end;

function  TMSSScriptControl.Get_CodeObject: IDispatch;
begin
  Result := DefaultInterface.Get_CodeObject;
end;

function  TMSSScriptControl.Get_Procedures: IScriptProcedureCollection;
begin
  Result := DefaultInterface.Get_Procedures;
end;

procedure TMSSScriptControl._AboutBox;
begin
  DefaultInterface._AboutBox;
end;

procedure TMSSScriptControl.AddObject(const Name: WideString; const Object_: IDispatch; 
                                      AddMembers: WordBool);
begin
  DefaultInterface.AddObject(Name, Object_, AddMembers);
end;

procedure TMSSScriptControl.Reset;
begin
  DefaultInterface.Reset;
end;

procedure TMSSScriptControl.AddCode(const Code: WideString);
begin
  DefaultInterface.AddCode(Code);
end;

function  TMSSScriptControl.Eval(const Expression: WideString): OleVariant;
begin
  Result := DefaultInterface.Eval(Expression);
end;

procedure TMSSScriptControl.ExecuteStatement(const Statement: WideString);
begin
  DefaultInterface.ExecuteStatement(Statement);
end;

function  TMSSScriptControl.Run(const ProcedureName: WideString; var Parameters: PSafeArray): OleVariant;
begin
...
procedure Register;
begin
  // Don't register it just for the OTA. Uncomment, if you will.
  //RegisterComponents('ActiveX',[TMSSScriptControl]);
end;
