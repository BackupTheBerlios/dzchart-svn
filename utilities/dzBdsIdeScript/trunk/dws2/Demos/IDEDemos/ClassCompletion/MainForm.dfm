  ...
  object SynEdit1: TSynEdit
    ...
    Lines.Strings = (
      ...
      '    property Tag: Integer read GetTag write SetTag;'
        ...
        '    property Text: TSpecialText read FSpecialText write SetSpeci' +
        'alText;'
      '  end;'
      ''
      'type'
      ...
      '    property Weight: Float read GetWeight write SetWeight;'
        ...
        '    property Objects[Index: Integer]: TObject read GetObject wri' +
        'te SetObject;'
      
        '    property Pixels[X, Y: Integer]: TColor read GetPixel write S' +
        'etPixel;'
      
        '    property Values[const Name: string]: string read GetValue wr' +
        'ite SetValue;'
      '  end;')
  end
