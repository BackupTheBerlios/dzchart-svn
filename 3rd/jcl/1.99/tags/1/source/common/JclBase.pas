...
const
  ...
  JclVersionMinor   = 99;   // Fifth minor release since JCL 1.90
  JclVersionRelease = 1;    // 0: pre-release|beta/>=1: release
  JclVersionBuild   = 2551; // build number, days since march 1, 2000
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jcl.svn.sourceforge.net/svnroot/jcl/tags/JCL199-Build2551/jcl/source/common/JclBase.pas $';
