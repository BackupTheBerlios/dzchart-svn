    ...
    if Column = nil then begin
      ...
      case Column.Index of
        0: // Will never come here.
          ;
        1: {// Background only customization.} begin
        ...
        2: {// Full customization. Check elements to learn what must be drawn in the various stages.} begin
            if hpeBackground in Elements then
              with FBackBitmap2 do begin
...
begin
  ...
  with FCheckerBackground do begin
    Width := 16;
    Height := 16;
